...
class UserSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recyclerUserSelect)
        textEmpty = findViewById(R.id.textEmpty)
        adapter = UserSelectAdapter(users) { user ->
    ...
    private fun loadUsers() {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@UserSelectActivity, "Failed to load users", Toast.LENGTH_SHORT).show()
            }
        })
    }
}